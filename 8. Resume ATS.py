...
# function for get response from genai
...
# match the resume with job description
submit3 = st.button("Percentage match")

input_prompt1 = """
    You are an experienced Technical Human Resource Manager,your task is to review the provided resume against 
    the job description. Please share your professional evaluation on whether the candidate's profile aligns 
    with the role. Highlight the strengths and weaknesses of the applicant in relation to the specified 
    job requirements.
"""
...
# if clicked resume match with job description
elif submit3:
    if uploaded_file is not None:
        pdf_content=input_pdf_setup(uploaded_file)
